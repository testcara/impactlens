...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    ...
    <h3 style="color: #059669;">How to Use Your Anonymous ID</h3>
    <p>
        <strong>Find Your Personal Metrics:</strong><br>
        Use your anonymous ID to locate your individual performance data in the reports
        generated by this PR. Search for your ID (e.g., "{anonymous_id}") in the uploaded
        reports to see your personal metrics.
    </p>
    ...
    <p>
        This feature gives you control over your privacy while allowing you to review your
        own performance and optionally connect it to your identity if you choose.
    </p>
